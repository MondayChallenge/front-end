...
const Messages = () => {
  return (
    <div class="new-messages border-class-1">
      ...
      <p class="june-15-20-at-1214-pm valign-text-middle font-class-1 border-class-1">
        June 15, 2020 at 12:14 PM
      </p>
      <div class="today-C61RwL valign-text-middle font-class-1 border-class-1">
        Today
      </div>
      <img class="image-17" src="" />
      <div class="kristen-smith-C61RwL valign-text-middle font-class-1 border-class-1">
        Kristen Smith
      </div>
      <div class="kristen-smith-VMr6Om valign-text-middle font-class-1 border-class-1">
        Kristen Smith
      </div>
      ...
      <p class="quotation--stallation-C61RwL valign-text-middle font-class-2 border-class-1">
        Quotation for Air Duct Installation
      </p>
      <div class="today-VMr6Om valign-text-middle font-class-1 border-class-1">
        Today
      </div>
      <div class="david-felber valign-text-middle font-class-1 border-class-1">
        David Felber
      </div>
      ...
      <p class="quotation--stallation-VMr6Om valign-text-middle font-class-2 border-class-1">
        Quotation for Air Duct Installation
      </p>
      <div class="quotation--stallation-mzXdH9 valign-text-middle font-class-2 border-class-1">
        Quotation for Air Duct Installation
      </div>
      ...
      <div class="sort-newest-first valign-text-middle font-class-4 border-class-1">
        <span>
      ...
      <div class="ks-C61RwL valign-text-middle font-class-3 border-class-1">
        KS
      </div>
      <img class="ellipse-1-VMr6Om" src="" />
      <div class="ks-VMr6Om valign-text-middle font-class-3 border-class-1">
        KS
      </div>
      <img class="line-8" src="" />
      <div class="today-mzXdH9 valign-text-middle font-class-1 border-class-1">
        Today
      </div>
      <div class="wesley-thomas valign-text-middle font-class-1 border-class-1">
        Wesley Thomas
      </div>
      ...
      <p class="quotation--stallation-QxM5SU valign-text-middle font-class-2 border-class-1">
        Quotation for Air Duct Installation
      </p>
      <img class="ellipse-1-mzXdH9" src="" />
      <div class="wt valign-text-middle font-class-3 border-class-1">WT</div>
