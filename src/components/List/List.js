      ...
      <table className="listTable">
        <thead className="listHead">
          <tr>
            ...
            <th className="project-owner headItem  font-class-1 ">Project Owner</th>
        ...
        <tbody>
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> Mattamy Development</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
              ...
              />
              <span className="listItem-projectOwner   font-class-1 ">David Felb</span>
            </td>
          ...
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> Greystone Estates</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
                src="https://anima-uploads.s3.amazonaws.com/projects/5fa1a82d0aa76a11ee1c02fa/releases/5fa1b6c90aa76a11ee1c03d5/img/image-17@2x.png"
              />
          ...
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> Fairview Shopping Center</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
                src="https://anima-uploads.s3.amazonaws.com/projects/5fa1a82d0aa76a11ee1c02fa/releases/5fa1b6c90aa76a11ee1c03d5/img/image-17@2x.png"
              />
          ...
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> NorthCoast Development</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
                src="https://anima-uploads.s3.amazonaws.com/projects/5fa1a82d0aa76a11ee1c02fa/releases/5fa1b6c90aa76a11ee1c03d5/img/image-17@2x.png"
              />
          ...
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> Royal Homes Corporation</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
                src="https://anima-uploads.s3.amazonaws.com/projects/5fa1a82d0aa76a11ee1c02fa/releases/5fa1b6c90aa76a11ee1c03d5/img/image-17@2x.png"
              />
          ...
          <tr className="listEntry ">
            <td className="listItem title font-class-1 "> Capstone Project</td>
            <td className="listItem font-class-1 ">
              <img className="listItem-image" alt=""
                src="https://anima-uploads.s3.amazonaws.com/projects/5fa1a82d0aa76a11ee1c02fa/releases/5fa1b6c90aa76a11ee1c03d5/img/image-17@2x.png"
              />
