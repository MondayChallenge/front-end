...
import {
  ...
  LABOR,
  MISCELLANEOUS,
} from 'components/utils/standardNaming';
...
const BidCreation = (props) => {
  ...
  const renderBidDetails = (counter, name) => {
    ...
    for (let i = 0; i <= counter; i++) {
      renderElement.push(
        <div className="form-inputs-row" key={`${name}_${i}`}>
          ...
          <div className="form-inputs-block form-inputs-block--small">
            ...
            <Field
              ...
              className="form-inputs form-inputs--small"></Field>
          </div>
        </div>
      );
    }
    ...
    <div className="dashboard-projects">
      ...
      <Formik
        initialValues={{
          ...
          project: props.match.params.id, //from where you chose the project
        ...
        {({ errors, touched }) => (
          <Form action="" className="bid-creation">
            ...
            <p className="form-section-subheader ">
              Please fill out the required fields below to provide us with the
              details of the company bidding on this proposal.
            </p>
            ...
            <div className="form-inputs-section">
              ...
              <div className="form-inputs-block form-inputs-block--large">
                ...
                <Field
                  name="notes"
                  className="form-inputs form-inputs--large"></Field>
              </div>
            </div>

            <h1 className="form-section-header">Attachments</h1>
            <p className="form-section-subheader ">
              Please upload the scope of work, images, or additional
              documentation for bidders to review prior to submitting a project
              bid.
            </p>
            ...
            <p className="form-section-subheader ">
              Bidders shall include in their bid the cost of providing all
              labor, material, equipment, supervision, services, taxes,
              insurance, licenses, fees, overhead and profit, etc. necessary or
              incidentally required to complete the subcontract work including,
              but not limited to, the attached scope of work and clarifications
            ...
            <div className="bid-creation__summary">
              <p className="bid-creation__summary__note">
                Note: It is understood that this Bid shall remain in effect, and
                may not be withdrawn, for a period of ninety (90) days from the
                date that bids are due to be received.
              </p>
            ...
            <input
              type="submit"
              value="Submit"
              className="bid-creation__submit-btn submit-btn"></input>
          </Form>
        )}
      </Formik>
    </div>
